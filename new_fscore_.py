...
for i in range(0,500):
	...
	with open(file_name, 'r', encoding='utf-8',  errors='ignore') as f:
		for line in f:
			...
			morpho = word[2]
			list_true.append(lemma +";"+str(morhophology(morpho))) 
	
	
	list_pred = []
	#file_name = "ACL_csv/"+str(i)+".csv"
	file_name = "Strategy1_csv/"+str(i)+".csv"
	...
	p_true_positive += true_positive
	p_false_negative += false_negative
	p_false_positive += false_positive
